            ...
            <div className="max-w-5xl mx-auto px-6 z-10 text-center relative">
                ...
                >
                    ...
                    <div className="flex flex-col md:flex-row gap-6 justify-center items-center">
                        ...
                        <a href="dist/assets/Krishna_Resume (5).pdf" download className="px-8 py-3 rounded-lg bg-gradient-to-r from-blue-600 to-purple-600 text-white font-bold hover:shadow-[0_0_20px_rgba(79,70,229,0.5)] transition-all flex items-center gap-2 transform hover:-translate-y-1">
                            <Download size={18} />
                            Download Resume
                        </a>
